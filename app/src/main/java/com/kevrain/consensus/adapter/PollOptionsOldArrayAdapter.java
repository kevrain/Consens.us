 ...
 */
public class PollOptionsOldArrayAdapter extends RecyclerView.Adapter<PollOptionsOldArrayAdapter.ViewHolder> {
    ...
    public PollOptionsOldArrayAdapter(List<PollOption> pollOptions) {
    ...
    @Override
    public PollOptionsOldArrayAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        Context context = parent.getContext();
        LayoutInflater inflater = LayoutInflater.from(context);

        // Inflate the custom layout
        View listItemView = inflater.inflate(R.layout.item_poll_option_old, parent, false);
    ...
    @Override
    public void onBindViewHolder(PollOptionsOldArrayAdapter.ViewHolder holder, int position) {
